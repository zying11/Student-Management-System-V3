...
//                 setTeacherData({
//                     teacher: res.data, // Assuming res.data is the student object
//                     loading: false,
//                 });
//             } catch (error) {
...
//     const { teacher, loading } = teacherData;
...
//         "Password",
//     ];
//     const tableHeaderSubjectTeaching = [
//         "ID",
//         "Subject",
//         "Study Level",
//         "Class Time",
...
//         ],
//     ]
//     : teacher.login_details
//         ? [
//             [
//                 teacher.login_details.id || "-",
//                 teacher.login_details.email || "-",
//                 "********",
//             ],
//         ]
//         : [];

//     const tableDataSubjectTeaching = teacherData.loading
//         ? [
//               [
...
//               ],
//           ]
//         : teacher.subject_teaching.map((subjectTeaching) => [
...
//     return (
//         <>
//             <div className="page-title">Teacher</div>
...
//                                             <p>Phone Number:</p>
//                                             <p>
//                                                 {teacherData.teacher.phone_number}
//                                             </p>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                         <div>
//                                             <p>Gender:</p>
//                                             <p>{teacherData.teacher.gender}</p>
//                                         </div>
//                                     </div>
//                                 </div>
//                             </div>
...
//                                             <p>Birth Date:</p>
//                                             <p>
//                                                 {teacherData.teacher.birth_date}
//                                             </p>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                         <div>
//                                             <p>Address:</p>
//                                             <p>{teacherData.teacher.address}</p>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                 {error && <div className="alert alert-danger">{error}</div>}
//                 <Table
//                     header={tableHeaderSubjectTeaching}
//                     data={tableDataSubjectTeaching}
//                     itemsPerPage={3}
//                 />
//             </ContentContainer>
