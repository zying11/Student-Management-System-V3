        ...
        <div className="reset-password-form-container box-area row p-3">
            ...
            <div className="col p-5">
                <div className="row">
                    ...
                    <small className="reset-password-message text-center mb-4">Reset your new password here</small>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <div className="d-grid">
                            <Button className="btn-create-yellow" type="submit" variant="primary">Reset</Button>
                        </div>
                    </Form>
                </div>
            </div>
